  ...
  return ReactDOM.createPortal(
    ...
    >
      ...
      <div className="modal-content bg-white relative z-10 p-10 rounded-lg  w-full max-w-[482px]">
        <span
          className="absolute top-0 right-0 flex items-center justify-center w-10 h-10 bg-white border border-gray-300 rounded-full cursor-pointer -translate-y-2/4 translate-x-2/4"
          onClick={handelClose}
        >
          <svg
            width="14"
        ...
        <div className="flex flex-col gap-3 mb-5">
          ...
          <input
            type="email"
            id="email"
            className="w-full p-3 text-sm leading-normal outline-none bg-[#e7ecf3] rounded-lg"
